...
export const List: React.ComponentClass<IListOwnProps> = connect<IListStateProps, IListDispatchProps, IListOwnProps>(mapStateToProps, mapDispatchToProps)(ListComponent);
